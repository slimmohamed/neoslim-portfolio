...
document.addEventListener('DOMContentLoaded', () => {
  ...
  bondElements(); // Call once on load
  window.addEventListener('resize', bondElements); // Reapply on resize
});
...
function navigateWithAnimation(url) {
  ...
  loader.innerHTML = `
    <svg class="pl" width="240" height="240" viewBox="0 0 240 240">
      <circle class="pl__ring pl__ring--a" cx="120" cy="120" r="105" fill="none" stroke="#5EA08C" stroke-width="20"></circle>
      <circle class="pl__ring pl__ring--b" cx="120" cy="120" r="35" fill="none" stroke="#F5DEB3" stroke-width="20"></circle>
      <circle class="pl__ring pl__ring--c" cx="85" cy="120" r="70" fill="none" stroke="#2B6777" stroke-width="20"></circle>
      <circle class="pl__ring pl__ring--d" cx="155" cy="120" r="70" fill="none" stroke="#CFEF00" stroke-width="20"></circle>
    </svg>`;
...
function initAnimations() {
  ...
  panels.forEach(panel => {
    panel.addEventListener('mouseenter', () => {
      gsap.to(panel, { y: -10, duration: 0.3, ease: "power2.out" });
    });
