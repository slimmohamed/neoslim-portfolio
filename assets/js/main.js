...
heroBtn.addEventListener('click', function() {
  ...
  if(worksSection.classList.contains('opened')) {
    ...
    // Toggle Functions for Portfolio Content
    ...
    function init() {
        ...
        document.querySelectorAll('[onclick^="hidePortfolioContent"]').forEach(btn => {
            ...
            function showWorksSection() {
                ...
                toggleWorksBtn.classList.add('active'); // dans showWorksSection()
        ...
        function toggleWorksSection() {
            const worksSection = document.getElementById('works-section');
            // Add event listeners to home buttons in portfolio sections
            document.querySelectorAll('[onclick="hideAllCollapsibleSections()"]').forEach(button => {
